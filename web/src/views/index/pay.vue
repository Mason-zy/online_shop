...
import {mockPayApi} from '/@/api/order'
...
onMounted(() => {
  ...
  ddlTime.value = formatDate(date.getTime(), 'YY-MM-DD hh:mm:ss')
})
...
const handlePay = () => {
  ...
  mockPayApi({id: orderId.value}).then(res => {
    message.success('支付成功')
    router.push('/index/user/order-view')
  }).catch(err => {
